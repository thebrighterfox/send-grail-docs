...
- **Resend** action with a resend counter on [email log](/features/email-logging#resending-an-email) rows.

### Fixed

- Unreadable SMTP responses and headers in the [email log](/features/email-logging#delivery-status).
